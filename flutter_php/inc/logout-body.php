    ...
    <div class="container-fluid">
        <div class="row" style="padding-top: 10%;">
            ...
            <div class="col-md-4" style="text-align: center; background-color: #fffff333; border-radius: 20px; padding: 10px;" >
                ...
                <img src="assets/img/logout-2.png" height="250px"><br>
                <span style="font-weight:100; color:black;">Logged Out Securely...<br><br>
                You will Be Redirected to Home After 5sec</span>
